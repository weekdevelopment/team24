            ...
            <div class="" style="width: 100%;">
                <div class="card events-card mb-5 px-3" style="height: auto;">
                    <div>
                        ...
                        <form action="${path1 }/file/filelist1.do" method="get" class="field has-addons has-addons-right">
                            <p class="control">
                                <span class="select">
                        ...
                        <table class="table" id="tb1">
                            ...
                            <c:forEach var="board" items="${fileboardList}" varStatus="status">
                                <tr>
                                    ...
                                    <td class="item3">
                                        <div class="btn-group">
                                            <a href="${path1}/file/removeFileboard.do?postNo=${board.fileBoard.postNo}" class="button2">자료 삭제</a>
                                        </div>
                                    </td>
                                </tr>
                            </c:forEach>
